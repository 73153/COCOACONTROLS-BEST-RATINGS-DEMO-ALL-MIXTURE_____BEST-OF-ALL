...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    ...
    if (self) {
        self.DKImageWidth = self.view.bounds.size.width - 10;
        self.DKImagePadding = 20;
        self.DKThumbnailStripHeight = 100;
        self.DKBackgroundColor = [UIColor colorWithRed:0.941 green:0.941 blue:0.941 alpha:1] ;
...
- (void)viewWillAppear:(BOOL)animated {
    NSLog(@"chenbo: inside view will appear");
    ...
    NSLog(@"chenbo: frame size is %f and %f", frame.size.width, frame.size.height);
